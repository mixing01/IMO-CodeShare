...
import edu.put.imo.lab6.GreedyLS;
...
public class GeneticSplit {
    private static ArrayList<TSPSolution> initializePopulation(int popSize, String filepath) throws FileNotFoundException {
        ...
        for(int i = 0; i < popSize; i++) {
            TSPSolution solution = PointSplitter.splitFromFile(filepath);
            GreedyLS.greedySearch(solution, NeighbourType.EDGE);
